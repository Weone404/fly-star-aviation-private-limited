...
| 2026-08-22 | C3 pilot training institute in Delhi NCR | websearch | No | — | — | goldenepaulettes (#1), flapone, fmsaviation ×2, captsahilkhurana, flyera, IGIA | Shiksha ("23 colleges in Delhi/NCR") |
| 2026-08-22 | C5 RTR(A) classes Delhi | websearch | No | — | — | Capt Ravinder Sherawat, goldenepaulettes, topcrewaviation, aviationtraining.co.in, aviationplanet | **IndiaMART ×3**, Facebook, worldorgs |
| 2026-08-22 | B9 ATPL ground classes India | websearch | No | — | — | topcrewaviation, goldenepaulettes, atplgroundclasses.com ×3, herculesaviation, captsahilkhurana, airshipaviation | — |
| 2026-08-22 | D3 CPL vs ATPL difference | websearch | No | — | — | **All EASA/UK sources** — aviationjobsearch, Bristol Groundschool, Sherburn Aero Club, victorone.eu, globaltrainingaviation | — |
| 2026-08-22 | D4 DGCA ground classes vs self study | websearch | No | — | — | thepilot.in, cntaaonline, dgcacplgroundclasses, fmsaviation, poeticpilot, thepilotscompass, pioneerflyingacademy | **Quora (#2)** |
| 2026-08-22 | D5 IndiGo cadet pilot programme 2026 | websearch | No | — | — | goldenepaulettes (#1), apano, airshipaviation, aviatorsoftomorrow, poeticpilot, mgavia | — |
| 2026-08-22 | A2 "Flying Star Aviator" Dwarka | websearch | **YES** | ~7 | `/` | — (brand) | **Justdial ×4 (two distinct listing IDs)**, RegisterKaro (CIN), Instagram |
| 2026-08-22 | A4 flystar.co.in | websearch | **NO** | — | — | **flystars.co.in ranks first** | Internshala, Justdial, YouTube, Wikipedia noise |
| 2026-08-22 | A5 "Flying Star Aviator" fees | websearch | Yes | ~5 | `/` | US flight schools dominate | — |
...
### Batch 3 additions — BASELINE NOW COMPLETE (25 of 25, all pre-deploy)
10. **Final presence rate: 3 of 25.** flystar.co.in surfaces only on three
...
12. **"CPL vs ATPL" is served entirely by EASA/UK sources** (Bristol
    ...
    strongly validates calendar topic #15, which should be retitled to make
    the India/DGCA framing explicit.
13. **Ramphal Chowk, Dwarka is described in ranking content as "India's
    largest concentration of pilot training institutes."** The business sits
    in the single most contested micro-market in the country for this service
    and ranks nowhere in it.
14. **Third-party surfaces, now fully enumerated** (the entity-mentions target
...
### ⚠️ Company-record findings (bear directly on the outstanding facts block)
- **CIN found publicly: `U85499DL2024PTC435001`** (RegisterKaro listing for
  FLYING STAR AVIATOR PRIVATE LIMITED). The `2024` segment indicates the
  private limited company was **incorporated in 2024**.
- **Three different founding dates are now in circulation:** the site's schema
  and llms.txt say **2008**; a Justdial listing says **established 2016**; the
  CIN indicates the company was incorporated in **2024**.
  A business can trade for years before incorporating a Pvt Ltd, so these are
  not necessarily contradictory — but "Operating since 2008" and "15+ Years
  Experience" are claims the legal entity cannot evidence on its own.
  **[CONFIRM] — this is fact 1 of the facts block, now partially answered.**
- **Registered address (RegisterKaro):** C705, 1st Floor, Palam Extn, Ramphal
  Chowk, Dwarka Sec-7, Bagdola, South West Delhi, New Delhi 110077 — more
  precise than the address in the site's Organization schema.
- **Internshala company profile lists "2–10 employees."** Set against
  `/about`'s "5000+ Trained Pilots", "50+ Partner Airlines" and "8 Training
  Centers", these cannot all be true. Feeds the claims-truth pass (R3).
