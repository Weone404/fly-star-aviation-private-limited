...
export const STATIC_BLOG_POSTS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How much does the DGCA exam cost per paper?", a: "&#8377;2,500 per paper in a regular session and &#8377;5,000 per paper through the Online On-Demand Examination route. OLODE lets you choose a slot instead of waiting for a session date, and fees are not refunded or adjusted once you submit." },
...
<p>The DGCA examination fees sit outside all of this and do not change with your choice of school: 2,500 rupees per paper in a regular session, or 5,000 rupees per paper through the Online On-Demand Examination route, and the fee is not refunded once submitted.<sup>[<a href="https://pariksha.dgca.gov.in/Form/PLT_FAQs" target="_blank" rel="noopener">1</a>]</sup> Budget them separately from anything the FTO quotes you.</p>
